        ...
        <div class="w-2xl border border-gray-400 rounded p-8 bg-gray-950/40">
            ...
            <form action="{{ route("products.store") }}" method="POST" class="mt-4 flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input name="name" type="text" placeholder="Pneu" class="border border-gray-400 rounded px-4 py-1">
                </div>

                <div class="flex flex-col gap-1">
                    <label for="description">Descrição</label>
                    <textarea name="description"
                        class="border border-gray-400 rounded px-4 py-1 max-h-28 min-h-7"></textarea>
                </div>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input name="quantity" type="text" placeholder="0" class="border border-gray-400 rounded px-4 py-1"
                        value="0">
                </div>
                <x-default-button>
